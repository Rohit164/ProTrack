...
__turbopack_require__("[externals]/node:fs [external] (node:fs, cjs)"), __turbopack_require__("[externals]/node:path [external] (node:path, cjs)");
const node = __turbopack_require__("[project]/node_modules/node-fetch-native-with-agent/dist/node.cjs [app-route] (ecmascript)");
__turbopack_require__("[externals]/node:http [external] (node:http, cjs)"), __turbopack_require__("[externals]/node:https [external] (node:https, cjs)"), __turbopack_require__("[externals]/node:zlib [external] (node:zlib, cjs)"), __turbopack_require__("[externals]/node:stream [external] (node:stream, cjs)"), __turbopack_require__("[externals]/node:buffer [external] (node:buffer, cjs)"), __turbopack_require__("[externals]/node:util [external] (node:util, cjs)"), __turbopack_require__("[project]/node_modules/node-fetch-native-with-agent/dist/shared/node-fetch-native-with-agent.61758d11.cjs [app-route] (ecmascript)"), __turbopack_require__("[externals]/node:url [external] (node:url, cjs)"), __turbopack_require__("[externals]/node:net [external] (node:net, cjs)");
let s = 0;
const S = {
    START_BOUNDARY: s++,
...
//# sourceMappingURL=dd92d_modules_node-fetch-native-with-agent_dist_chunks_multipart-parser_cjs_01b784._.js.map