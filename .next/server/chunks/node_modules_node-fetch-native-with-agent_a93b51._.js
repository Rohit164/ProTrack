...
const mr = Symbol.toStringTag, yi = n((i1)=>typeof i1 == "object" && typeof i1.append == "function" && typeof i1.delete == "function" && typeof i1.get == "function" && typeof i1.getAll == "function" && typeof i1.has == "function" && typeof i1.set == "function" && typeof i1.sort == "function" && i1[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n((i1)=>i1 && typeof i1 == "object" && typeof i1.arrayBuffer == "function" && typeof i1.type == "string" && typeof i1.stream == "function" && typeof i1.constructor == "function" && /^(Blob|File)$/.test(i1[mr]), "isBlob"), Qs = n((i1)=>typeof i1 == "object" && (i1[mr] === "AbortSignal" || i1[mr] === "EventTarget"), "isAbortSignal"), Ys = n((i1, o)=>{
    ...
    async formData() {
        ...
        const { toFormData: a } = await __turbopack_require__("[project]/node_modules/node-fetch-native-with-agent/dist/chunks/multipart-parser.mjs [app-route] (ecmascript, async loader)")(__turbopack_import__);
...
const require$$0 = __turbopack_require__("[externals]/node:assert [external] (node:assert, cjs)"), require$$4 = __turbopack_require__("[externals]/node:net [external] (node:net, cjs)"), http$1 = __turbopack_require__("[externals]/node:http [external] (node:http, cjs)"), Stream = __turbopack_require__("[externals]/node:stream [external] (node:stream, cjs)"), require$$6 = __turbopack_require__("[externals]/node:buffer [external] (node:buffer, cjs)"), require$$0$1 = __turbopack_require__("[externals]/node:util [external] (node:util, cjs)"), require$$8 = __turbopack_require__("[externals]/node:querystring [external] (node:querystring, cjs)"), require$$0$2 = __turbopack_require__("[externals]/node:diagnostics_channel [external] (node:diagnostics_channel, cjs)"), require$$0$3 = __turbopack_require__("[externals]/node:events [external] (node:events, cjs)"), _commonjsHelpers = __turbopack_require__("[project]/node_modules/node-fetch-native-with-agent/dist/shared/node-fetch-native-with-agent.61758d11.cjs [app-route] (ecmascript)"), require$$4$1 = __turbopack_require__("[externals]/node:tls [external] (node:tls, cjs)"), zlib = __turbopack_require__("[externals]/node:zlib [external] (node:zlib, cjs)"), require$$5 = __turbopack_require__("[externals]/node:perf_hooks [external] (node:perf_hooks, cjs)"), require$$8$1 = __turbopack_require__("[externals]/node:util/types [external] (node:util/types, cjs)"), require$$0$4 = __turbopack_require__("[externals]/node:os [external] (node:os, cjs)"), require$$1 = __turbopack_require__("[externals]/node:url [external] (node:url, cjs)"), require$$5$1 = __turbopack_require__("[externals]/node:async_hooks [external] (node:async_hooks, cjs)");
__turbopack_require__("[externals]/node:console [external] (node:console, cjs)");
const require$$5$2 = __turbopack_require__("[externals]/string_decoder [external] (string_decoder, cjs)"), require$$2 = __turbopack_require__("[externals]/node:worker_threads [external] (node:worker_threads, cjs)");
...
function requireUtil$5() {
    ...
    let S = [], k;
    try {
        k = __turbopack_require__("[externals]/node:crypto [external] (node:crypto, cjs)");
        const y = [
            "sha256",
            "sha384",
            "sha512"
...
try {
    http2 = __turbopack_require__("[externals]/node:http2 [external] (node:http2, cjs)");
} catch  {
    http2 = {
        constants: {}
    };
...
function requireConnection() {
    ...
    let l;
    try {
        l = __turbopack_require__("[externals]/node:crypto [external] (node:crypto, cjs)");
    } catch  {}
...
function requireFrame() {
    ...
    let A;
    try {
        A = __turbopack_require__("[externals]/node:crypto [external] (node:crypto, cjs)");
    } catch  {}
    const n = class n {
        constructor(s){
...
const http = __turbopack_require__("[externals]/node:http [external] (node:http, cjs)"), https = __turbopack_require__("[externals]/node:https [external] (node:https, cjs)"), zlib = __turbopack_require__("[externals]/node:zlib [external] (node:zlib, cjs)"), Stream = __turbopack_require__("[externals]/node:stream [external] (node:stream, cjs)"), require$$6 = __turbopack_require__("[externals]/node:buffer [external] (node:buffer, cjs)"), require$$0 = __turbopack_require__("[externals]/node:util [external] (node:util, cjs)"), _commonjsHelpers = __turbopack_require__("[project]/node_modules/node-fetch-native-with-agent/dist/shared/node-fetch-native-with-agent.61758d11.cjs [app-route] (ecmascript)"), require$$1 = __turbopack_require__("[externals]/node:url [external] (node:url, cjs)"), require$$4 = __turbopack_require__("[externals]/node:net [external] (node:net, cjs)"), node_fs = __turbopack_require__("[externals]/node:fs [external] (node:fs, cjs)"), node_path = __turbopack_require__("[externals]/node:path [external] (node:path, cjs)");
...
if (!globalThis.ReadableStream) try {
    const c1 = __turbopack_require__("[externals]/node:process [external] (node:process, cjs)"), { emitWarning: l } = c1;
    try {
        c1.emitWarning = ()=>{}, Object.assign(globalThis, __turbopack_require__("[externals]/node:stream/web [external] (node:stream/web, cjs)")), c1.emitWarning = l;
    } catch (d) {
...
try {
    const { Blob: c1 } = __turbopack_require__("[externals]/buffer [external] (buffer, cjs)");
...
const NAME = Symbol.toStringTag, isURLSearchParameters = u((c1)=>typeof c1 == "object" && typeof c1.append == "function" && typeof c1.delete == "function" && typeof c1.get == "function" && typeof c1.getAll == "function" && typeof c1.has == "function" && typeof c1.set == "function" && typeof c1.sort == "function" && c1[NAME] === "URLSearchParams", "isURLSearchParameters"), isBlob = u((c1)=>c1 && typeof c1 == "object" && typeof c1.arrayBuffer == "function" && typeof c1.type == "string" && typeof c1.stream == "function" && typeof c1.constructor == "function" && /^(Blob|File)$/.test(c1[NAME]), "isBlob"), isAbortSignal = u((c1)=>typeof c1 == "object" && (c1[NAME] === "AbortSignal" || c1[NAME] === "EventTarget"), "isAbortSignal"), isDomainOrSubdomain = u((c1, l)=>{
    ...
    async formData() {
        ...
        const { toFormData: d } = await __turbopack_require__("[project]/node_modules/node-fetch-native-with-agent/dist/chunks/multipart-parser.cjs [app-route] (ecmascript, async loader)")(__turbopack_import__);
...
if (!globalThis.DOMException) try {
    const { MessageChannel: c1 } = __turbopack_require__("[externals]/worker_threads [external] (worker_threads, cjs)"), l = new c1().port1, d = new ArrayBuffer;
    l.postMessage(d, [
        d,
        d
    ]);
...
__turbopack_require__("[externals]/node:http [external] (node:http, cjs)"), __turbopack_require__("[externals]/node:https [external] (node:https, cjs)"), __turbopack_require__("[externals]/node:zlib [external] (node:zlib, cjs)"), __turbopack_require__("[externals]/node:stream [external] (node:stream, cjs)"), __turbopack_require__("[externals]/node:buffer [external] (node:buffer, cjs)"), __turbopack_require__("[externals]/node:util [external] (node:util, cjs)"), __turbopack_require__("[project]/node_modules/node-fetch-native-with-agent/dist/shared/node-fetch-native-with-agent.61758d11.cjs [app-route] (ecmascript)"), __turbopack_require__("[externals]/node:url [external] (node:url, cjs)"), __turbopack_require__("[externals]/node:net [external] (node:net, cjs)"), __turbopack_require__("[externals]/node:fs [external] (node:fs, cjs)"), __turbopack_require__("[externals]/node:path [external] (node:path, cjs)");
...
var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, m: module, e: exports, t: __turbopack_require_real__ } = __turbopack_context__;
{
const nodeFetch = __turbopack_require__("[project]/node_modules/node-fetch-native-with-agent/dist/index.cjs [app-route] (ecmascript)");
...
const http = __turbopack_require__("[externals]/node:http [external] (node:http, cjs)"), https = __turbopack_require__("[externals]/node:https [external] (node:https, cjs)"), index = __turbopack_require__("[project]/node_modules/node-fetch-native-with-agent/dist/shared/node-fetch-native-with-agent.df7e6bd6.cjs [app-route] (ecmascript)"), nodeFetchNativeWithAgent = __turbopack_require__("[project]/node_modules/node-fetch-native-with-agent/lib/index.cjs [app-route] (ecmascript)");
__turbopack_require__("[externals]/node:assert [external] (node:assert, cjs)"), __turbopack_require__("[externals]/node:net [external] (node:net, cjs)"), __turbopack_require__("[externals]/node:stream [external] (node:stream, cjs)"), __turbopack_require__("[externals]/node:buffer [external] (node:buffer, cjs)"), __turbopack_require__("[externals]/node:util [external] (node:util, cjs)"), __turbopack_require__("[externals]/node:querystring [external] (node:querystring, cjs)"), __turbopack_require__("[externals]/node:diagnostics_channel [external] (node:diagnostics_channel, cjs)"), __turbopack_require__("[externals]/node:events [external] (node:events, cjs)"), __turbopack_require__("[project]/node_modules/node-fetch-native-with-agent/dist/shared/node-fetch-native-with-agent.61758d11.cjs [app-route] (ecmascript)"), __turbopack_require__("[externals]/node:tls [external] (node:tls, cjs)"), __turbopack_require__("[externals]/node:zlib [external] (node:zlib, cjs)"), __turbopack_require__("[externals]/node:perf_hooks [external] (node:perf_hooks, cjs)"), __turbopack_require__("[externals]/node:util/types [external] (node:util/types, cjs)"), __turbopack_require__("[externals]/node:os [external] (node:os, cjs)"), __turbopack_require__("[externals]/node:url [external] (node:url, cjs)"), __turbopack_require__("[externals]/node:async_hooks [external] (node:async_hooks, cjs)"), __turbopack_require__("[externals]/node:console [external] (node:console, cjs)"), __turbopack_require__("[externals]/string_decoder [external] (string_decoder, cjs)"), __turbopack_require__("[externals]/node:worker_threads [external] (node:worker_threads, cjs)");
...
//# sourceMappingURL=node_modules_node-fetch-native-with-agent_a93b51._.js.map