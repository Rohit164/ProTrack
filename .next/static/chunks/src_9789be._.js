(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_9789be._.js", {
...
(()=>{
    const e = new Error("Cannot find module './api/use-current'");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
(()=>{
    const e = new Error("Cannot find module '@/features/auth/components/api/use-current'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '@/features/auth/components/api/use-logout'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
...
//# sourceMappingURL=src_9789be._.js.map